    ...
    <div class="col-md-offset-2 col-md-5" style="margin-top: 80px">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
               <?php echo Form::open(['route' => 'reminders.store', 'data-toggle' => 'validator']); ?>

               <?php echo csrf_field(); ?>

                <div class="form-group">
                        <?php echo Form::text('title', null, array('class' => 'form-control', 'placeholder' => 'Title', 'required' => 'required', 'data-error' => 'Title must not be empty')); ?>
                ...
                <div class="form-group">
                    <?php echo Form::textarea('body',null, array('class' => 'form-control', 'placeholder' => 'Body', 'rows' => '3', 'style' => 'resize:vertical', 'required' => 'required', 'data-error' => 'Body must not be empty')); ?>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <?php echo Form::select('privacy', array('Public' => 'Public', 'Private' => 'Private'), 'Public', ['title' => 'Privacy Setting', 'class' => 'selectpicker form-control']); ?>

                        </div>
                         <div class="col-md-4">
                            <?php echo Form::label('due_date', 'Remind me on:'); ?>

                            <?php echo Form::text('due_date',$now, array('class' => 'form-control', 'placeholder' => 'Due Date','data-provide' => 'datepicker', 'data-date-format' => 'MM dd, yyyy', 'readonly' => 'readonly')); ?>

                        </div>
                        <div class="col-md-4">
                            <?php echo Form::label('tag', 'Tag:'); ?>

                            <?php echo Form::select('tag', array('School' => 'School', 'Personal' => 'Personal', 'Others' => 'Others'), 'School', ['class' => 'selectpicker form-control']); ?>
